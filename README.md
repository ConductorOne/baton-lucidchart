...
Flags:
  ...
  -h, --help                                             help for baton-lucidchart
      ...
      --lucid-content-transfer-user-email string         Email address of the user to transfer owned documents to before deleting a user. When set, a user delete first transfers their content to this user so it is retained. ($BATON_LUCID_CONTENT_TRANSFER_USER_EMAIL)
